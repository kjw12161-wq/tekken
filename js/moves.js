...
const MOVES = {
  ...
  sweep: {
    ...
    box: { x: 18, y: -26, w: 82, h: 22 }, sfx: 'heavy'
  },
  uppercut: {
  ...
  airKick: {
    ...
    box: { x: 18, y: -58, w: 70, h: 40 }, sfx: 'heavy'
  },
  /* ---------- 필살기 ---------- */
  kiBlast: {
  ...
  grab: {
    ...
    box: { x: 18, y: -108, w: 44, h: 76 }, sfx: 'heavy'
  }
};
